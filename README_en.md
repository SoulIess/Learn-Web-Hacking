...
Many sources were used as a reference, with corresponding links at the article's end. Many thanks to the authors for sharing these articles. Online versions of the Network Security notes can be viewed [here](https://websec.readthedocs.io)

It is important to note that only this Readme is translated. Readers can use the translated [table of contents](#table-of-contents) as a reference in finding specific topics and read the notes with the help of a translator.
